...
fake_substring = "Межа значень функції"
...
if __name__ == '__main__':
    ...
    for i, text in enumerate([text1, text2]):
        print(f"\nСтаття №{i+1}")
        results = []
        for pattern in [fake_substring,existing_substring ]:
            for search_func in [boyer_moore_search, regex_search,kmp_search,rabin_karp_search]:
